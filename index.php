...
<body>
    ...
    <div class="masonry-grid">
        ...
        if ($query_gallery && $query_gallery->num_rows > 0) {
            ...
            // Pastikan nama file di bawah ini sesuai dengan file yang kamu punya di folder project
    ...
    <div class="grid-3">
        ...
        if ($query_testi && $query_testi->num_rows > 0) {
            while ($testi = $query_testi->fetch_assoc()) {
                ...
                // Loop untuk menampilkan bintang sesuai rating di database
            ...
            // Tampilan jika data dummy belum masuk
